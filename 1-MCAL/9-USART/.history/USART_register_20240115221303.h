...
/*****************************************************************************************************/
#define UCSRB       *(u8*(volatile )0x40)      // UCSRC ==>usart control and status register ==>C
#define UCSRB_URSEL 7                          // Register Select
#define UCSRB_UMSEL 6                          // Mode Select
#define UCSRB_UPM1  5                          // the first bit for Parity select
#define UCSRB_UPM0  4                          // the secand bit for Parity select
#define UCSRB_USBS  3                          // Stop bit select
#define UCSRB_UCSZ2 2                          // the first bit for select the character size 
#define UCSRB_UCSZ1 1                          // the secand bit for select the character size 
#define UCSRB_UCSZ0 0                          // the third  bit for select the character size 
/********************************************************************************************************/
