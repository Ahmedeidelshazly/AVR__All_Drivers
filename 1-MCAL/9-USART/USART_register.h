...
/**********************************************************************************************/
#define UDR          *((volatile u8*)0x2C)             // UDR   ==>usart data register
/***********************************************************************************************/
#define UCSRA        *((volatile u8*)0x2B)     // UCSRA ==>usart control and status register ==>A
...
/*************************************************************************************************/
#define UCSRB       *((volatile u8*)0x2A)      // UCSRB ==>usart control and status register ==>B
...
/*****************************************************************************************************/
#define UCSRC       *((volatile u8*)0x40)      // UCSRC ==>usart control and status register ==>C
...
/********************************************************************************************************/
#define UBBRH *((volatile u8*)0x40)            // UBBRH ==>usart Baud Rate Register
/********************************************************************************************************/
#define UBBRL *((volatile u8*)0x29)            // UBBRL ==>usart Baud Rate Register
