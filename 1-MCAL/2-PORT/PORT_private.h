...
#define PORTA_dri   					CONC(PORTA_PIN7_dir,PORTA_PIN6_dir,PORTA_PIN5_dir,PORTA_PIN4_dir,PORTA_PIN3_dir,PORTA_PIN2_dir,PORTA_PIN1_dir,PORTA_PIN0_dir)
#define PORTB_dri						CONC(PORTB_PIN7_dir,PORTB_PIN6_dir,PORTB_PIN5_dir,PORTB_PIN4_dir,PORTB_PIN3_dir,PORTB_PIN2_dir,PORTB_PIN1_dir,PORTB_PIN0_dir)
#define PORTC_dri						CONC(PORTC_PIN7_dir,PORTC_PIN6_dir,PORTC_PIN5_dir,PORTC_PIN4_dir,PORTC_PIN3_dir,PORTC_PIN2_dir,PORTC_PIN1_dir,PORTC_PIN0_dir)
#define PORTD_dri						CONC(PORTD_PIN7_dir,PORTD_PIN6_dir,PORTD_PIN5_dir,PORTD_PIN4_dir,PORTD_PIN3_dir,PORTD_PIN2_dir,PORTD_PIN1_dir,PORTD_PIN0_dir)
